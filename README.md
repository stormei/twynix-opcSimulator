...
TwynIX is a TypeScript Node.js OPC UA server simulator for IIOT testbeds. It exposes a realistic plant hierarchy, updates simulated values every second by default, serves a small web configuration UI, and persists configuration as JSON.
